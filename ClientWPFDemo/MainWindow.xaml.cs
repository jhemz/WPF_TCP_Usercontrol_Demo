...
namespace ClientWPFDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void TimeLine_AddNewScene(object sender, EventArgs e)
        {
            vm.Scenes.Add(new vmTimelineScene() { Header = "New Scene", Id = Guid.NewGuid()});
        }

        private void Timelime_SceneStarted(object sender, SceneUpdateEvent e)
        {
            lblSceneUpdate.Content = e.Scene.Header + " has " + e.SceneEvent.ToString();
            vm.CurrentScene = e.Scene;
        }

        private void Timelime_SceneEnded(object sender, SceneUpdateEvent e)
        {
            lblSceneUpdate.Content = e.Scene.Header + " has " + e.SceneEvent.ToString();
        }
    }
